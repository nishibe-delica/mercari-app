    ...
    <div className="min-h-screen bg-gradient-to-br from-beige-50 via-white to-dusty-pink/10 px-4 py-6 sm:p-8">
      <div className="max-w-[640px] mx-auto">
        <div className="flex items-center gap-3 sm:gap-4 mb-6 sm:mb-8">
          ...
          <h2 className="text-2xl sm:text-3xl font-light text-gray-800">商品情報入力</h2>
        </div>

        <div className="bg-white rounded-2xl sm:rounded-3xl shadow-lg p-5 sm:p-8 space-y-5 sm:space-y-6">
          {/* 商品番号 */}
          <div>
            ...
            <input
              ...
              className="w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border border-beige-300 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-dusty-pink"
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2 sm:px-4 sm:py-3 text-sm sm:text-base border border-beige-300 rounded-lg sm:rounded-xl focus:outline-none focus:ring-2 focus:ring-dusty-pink h-20 sm:h-24 resize-none"
